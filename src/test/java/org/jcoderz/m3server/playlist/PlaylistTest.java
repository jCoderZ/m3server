...
public class PlaylistTest {
    ...
    public void testM3u() throws Exception {
        ...
        Item i = Library.LIBRARY.item(new Path("/audio/filesystem/01-gold/D/Dsk-2000/Electro-def/01 - intro.mp3"));
        pl.add(i);
        i = Library.LIBRARY.item(new Path("/audio/filesystem/01-gold/D/Dsk-2000/Electro-def/02 - lectro-def.mp3"));
        pl.add(i);
